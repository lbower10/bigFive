/*
 * File: position.h
 * Author: Prof arnold, with code added for PP10-11
 * by Logan Bowers and Matthew Krahel
 * Desccription: Contains declaration, functions, operators, constructors,
 * etc. for a templated class Position
 */
